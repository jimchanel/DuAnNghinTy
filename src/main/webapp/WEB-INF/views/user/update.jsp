	...
	<section class="vbox">
		<section class="scrollable padder">
			<ul
				...
				<li><a href=""><i class="fa fa-book"></i> Thông tin người dùng</a></li>
			</ul>
			<div class="row">
				<div class="col-sm-12">
					<section class="panel panel-default">
						<div class="panel-body">
							<form:form class="bs-example form-horizontal" id="frmAdd"
								data-validate="parsley" modelAttribute="userUpdate"
								action="sua-nguoi-dung.html" method="post">
								<h5 class="page-header m-t-xs" style="font-weight: 600;">
									<i class="fa fa-foursquare"></i> Thông tin người dùng
								</h5>
								...
								<c:choose>
									<c:when test="${userUpdate.username == 'admin' }">
										<div class="form-group m-b-xs">
									<span class="col-lg-2 control-span m-l">Tài khoản đăng
										nhập<font color="red">*</font> :
									</span>
									<div class="col-lg-3">
										<label class="form-control input-sm currency" hidden="true">admin</label>
									</div>
								</div>
									</c:when>
									<c:otherwise>
								...
								<c:if test="${userUpdate.username != 'admin' }">
								<div class="form-group m-b-xs">
